    ...
    <>
            ...
            >
              ...
              >
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                  <Link href="/products" className="bg-green-700 text-white px-6 md:px-8 py-3 rounded-full hover:bg-green-600 transition-colors block text-center">
                    {t('products')}
                  </Link>
                </motion.div>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                  <a href="#about" className="bg-white text-green-700 px-6 md:px-8 py-3 rounded-full hover:bg-gray-50 transition-colors block shadow-md text-center">
                    Learn More
                  </a>
                </motion.div>
              </motion.div>
      ...
      <section id="about" className="py-12 md:py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-green-800 mb-8 md:mb-16">About Millikit</h2>
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">Our Story</h3>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
            ...
            >
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-3 md:mb-4">100% Organic</h3>
              <p className="text-gray-600 text-sm md:text-base">Carefully sourced from organic farms, ensuring the highest quality millets.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-3 md:mb-4">Nutrient-Rich</h3>
              <p className="text-gray-600 text-sm md:text-base">Packed with essential nutrients, proteins, and minerals for your wellbeing.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-3 md:mb-4">Fast Delivery</h3>
              <p className="text-gray-600 text-sm md:text-base">Quick and secure delivery right to your doorstep across the country.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-green-800 mb-8 md:mb-16">Featured Products</h2>
          ...
          <div className="text-center mt-8 md:mt-12">
            <Link href="/products" className="inline-block bg-green-700 text-white px-6 md:px-8 py-3 rounded-full hover:bg-green-600 transition-colors shadow-md">
              View All Products
            </Link>
          </div>
        </div>
